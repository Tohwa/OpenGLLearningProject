...
void Mesh::Initialize(SShader* _shader)
{
	...
	vertices = {
		...
		//					  Front face(right)
			...
			{{-0.25f, -0.25f, 0.25f}, {0.0f, 0.5f, 0.5f,1.0f}},
		//						bottom face(NYI)
			{{-0.25f, -0.25f, 0.25f}, {1.0f, 0.5f, 0.5f,1.0f}},
			{{  0.0f,   0.0f,  0.5f}, {1.0f, 0.5f, 0.5f,1.0f}},
			{{ 0.25f, -0.25f, 0.25f}, {1.0f, 0.5f, 0.5f,1.0f}},
			{{  0.0f,  -0.5f,  0.0f}, {1.0f, 0.5f, 0.5f,1.0f}},
		//					  back face(right)(NYI)
			{{-0.25f,  0.25f, 0.25f}, {0.7f, 0.2f, 0.5f,1.0f}},
			{{-0.25f, -0.25f, 0.25f}, {0.7f, 0.2f, 0.5f,1.0f}},
			{{  0.0f,   0.0f,  0.5f}, {0.7f, 0.2f, 0.5f,1.0f}},
			{{  0.0f,   0.5f,  0.5f}, {0.7f, 0.2f, 0.5f,1.0f}},
		//					bottom face(left)(NYI)
			{{ 0.25f,  0.25f, 0.25f}, {1.0f, 0.5f, 1.0f,1.0f}},
			{{ 0.25f, -0.25f, 0.25f}, {1.0f, 0.5f, 1.0f,1.0f}},
			{{  0.0f,  -0.0f,  0.5f}, {1.0f, 0.5f, 1.0f,1.0f}},
			{{  0.0f,   0.5f,  0.5f}, {1.0f, 0.5f, 1.0f,1.0f}},
	};
